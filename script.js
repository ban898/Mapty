...
class App {
  ...
  _loadMap(position) {
    ...
    //Handlin clicks on the map
    this.#map.on('click', this._showForm.bind(this));

    //Show the markers of each workout we loaded from the storage
  ...
  _newWorkout(e) {
    ...
    //if workout is run create run obj
    if (type === 'running') {
    ...
    //if workout is cyc create cyc obj
    if (type === 'cycling') {
